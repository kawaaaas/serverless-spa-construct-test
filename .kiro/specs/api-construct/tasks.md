...
- [x] 1. ApiConstructの基本実装
  - [x] 1.1 ApiConstructPropsインターフェースを定義する
    - table: ITable（必須）
...
- [x] 4. Cognito認証の実装（オプション）
  - [x] 4.1 Cognito Authorizerを実装する
...
- [x] 6. ユニットテスト実装
  - [x] 6.1 REST API作成テストを実装する
    - REST APIリソースが作成されること
    - リソースポリシーが設定されること
    - CORSが有効であること
    - _要件: 1.1, 1.2, 1.4_
  - [x] 6.2 Lambda関数テストを実装する
    - Lambda関数が作成されること
